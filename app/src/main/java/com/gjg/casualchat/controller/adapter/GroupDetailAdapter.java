        ...
        if(mIsCanModify) {// 群主或开放了群权限
            ...
            if(position == getCount() - 1) {// 减号处理
                ...
                if(mIsDeleteModel) {
                    ...
                    holder.photo.setImageResource(R.drawable.cc_smiley_minus_btn_pressed);
                ...
                if(mIsDeleteModel) {
                    ...
                    holder.photo.setImageResource(R.drawable.cc_smiley_add_btn_pressed);
                    holder.delete.setVisibility(View.GONE);
                    holder.name.setVisibility(View.INVISIBLE);
                }
            }else {// 群成员
                ...
                holder.photo.setImageResource(R.drawable.cc_default_avatar);
