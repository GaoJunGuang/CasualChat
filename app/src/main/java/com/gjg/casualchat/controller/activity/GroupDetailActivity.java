...
import com.gjg.casualchat.controller.adapter.GroupDetailAdapter;
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Tools.showToastMessage(GroupDetailActivity.this, "删除成功");
                            }
                        });
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Tools.showToastMessage(GroupDetailActivity.this, "删除失败" + e.toString());
                            }
                        });
                    }
                }
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Tools.showToastMessage(GroupDetailActivity.this, "发送邀请成功");
                            }
                        });
                    } catch (final HyphenateException e) {
                        e.printStackTrace();
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Tools.showToastMessage(GroupDetailActivity.this, "发送邀请失败" + e.toString());
                            }
                        });
                    }
                }
